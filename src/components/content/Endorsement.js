      ...
      <div className="endorsement__container">
        <div className="person">
          <div className="photo__container">
            <div className="photo photo2">dummy</div>
          </div>
          <div className={`description ${truncate ? "expanded" : ""}`}>
            <span
              onClick={(e) => toggle(e)}
              className={`${
                truncate ? "fa fa-chevron-up" : "fa fa-chevron-down"
              }`}
            ></span>

            <p key="dummy" onClick={(e) => toggle(e)}>
              dummy person of some town stands in support of this candidate!
              <br />
              this is osme short bio text
            </p>
          </div>
        </div>
      </div>
